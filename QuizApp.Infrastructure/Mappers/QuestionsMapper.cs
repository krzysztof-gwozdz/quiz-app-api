...
namespace QuizApp.Infrastructure.Mappers
{
	public static class QuestionsMapper
	{
		...
		public static Question ToModel(this QuestionEntity entity) =>
			new Question(entity.Id, entity.Text, entity.Answers.Select(answer => new Question.Answer(answer.Id, answer.Text, answer.IsCorrect)).ToHashSet(), entity.Tags.ToHashSet());
