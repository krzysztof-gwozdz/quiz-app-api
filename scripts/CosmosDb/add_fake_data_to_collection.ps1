...
& $dataMigrationToolPath /s:JsonFile /s.Files:$jsonFilePath /t:DocumentDB /t.ConnectionString:$connectionString /t.Collection:$collection /t.PartitionKey:$partitionKey /t.IdField:$idField